...
--              including all columns with mismatched values per trade 
-- ==============================================================================================
...
and a.tradeParty2TransactionId = b.tradeParty2TransactionId
    ...
    (select stuff((
		select ','+clmn from ##EODSnapshotCompareSum
				where cobDate = cs.cobDate
					...
					and tradeParty2TransactionId = cs.tradeParty2TransactionId
					and value = 1
					and cobDate = @cobdate
		for xml path('')
		)
...
and m.tradeParty2TransactionId = FAEOD.tradeParty2TransactionId
...
--prepare all mismatched fields
exec srf_main.EodSnapshotGetAllDiff
