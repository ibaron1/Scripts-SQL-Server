...
select cast(create_date as varchar(24)) as [Statistics was updated]  from sys.databases
where name='tempdb'
...
-- Analyze Database I/O ranked by DB, IO Stall%
WITH DBIO AS
