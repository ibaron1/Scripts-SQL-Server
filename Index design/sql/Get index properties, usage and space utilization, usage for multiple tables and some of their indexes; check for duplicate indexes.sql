...
declare @tableindexes table(tbl sysname, idx sysname)

insert @tableindexes
values
('srf_main.Valuation', 'idx3_CounterPartySDSId'),
('srf_main.DataSecrecyMaster', 'NC1_SecretCPartyID'),
('srf_main.EODComment', 'NC1_EODComment'),
('srf_main.prodTypeAssetClassMap', 'Idx1_Prodtype_subtype'),
('srf_main.EMIRMultiManagerAccount', 'Idx_EMIR_Multi_SubAccountId')
...
join @tableindexes as ti
on i.object_id = object_id(tbl) and i.name = idx
...
select @@servername as Instance, db_name() as DbName, a.schemaName+'.'+tableName as tableName, a.indexName, 
