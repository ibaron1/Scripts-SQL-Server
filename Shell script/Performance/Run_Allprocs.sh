...
#############################################################################
#### create table a2query..testcase(testCaseID int, procname varchar(40), SQLText varchar(8000))
###  bcp a2query..testcase in TestCaseList -Ubaroneli -SNYQ_A2_INT2 -c -t'|' -r\\r
. RUN_ENV
. RUN_INIT

execSql=execSql_w_indDropped
...
$RunDir/GenerateProcExec.sh $procnm
