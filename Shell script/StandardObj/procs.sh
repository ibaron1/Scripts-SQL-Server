...
${SYB}/isql -b -D tempdb -S$SRV -U$UserName -P$PW <<!
set nocount on
...
$SYB/bcp tempdb..${MDAsrc} in ${MDAsrc}.out -S$SRV -U$UserName -P$PW -c -t'|' -r\\n

${SYB}/isql -b -D tempdb -SNYQ_A2_INT2 -U$UserName -P$PW <<!
drop table $a2query
go
...
select distinct name into tempdb..${a2query} 
...
${SYB}/isql -b -D tempdb -SNYP_RDG_HUB -U$UserName -P$PW <<!
drop table $a2query_history
go
