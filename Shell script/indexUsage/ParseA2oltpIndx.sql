if exists (select * from sysobjects where name='a2oltpIndDef_dtl')
  drop table a2oltpIndDef_dtl
go
create table a2oltpIndDef_dtl
...
--select * from a2oltpForeignKeyInd
go
