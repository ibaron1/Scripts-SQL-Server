...
if object_id('tfm.DataArchiveFinalSteps') is not null
  drop proc tfm.DataArchiveFinalSteps
go

/*****************************************************************************************************************************
Author. Eli Baron
Date created. 8-9-17
Purpose. Jira WMTRACAPGO-336, End of current archiving cycle or cycle's run, is to be called from DataArchivingForAllWorkflows
*****************************************************************************************************************************/
create proc tfm.DataArchiveFinalSteps
...
from after_del
where  ControlOfDataArchiving.DbName = db_name() and AppDataType = @AppDataType
